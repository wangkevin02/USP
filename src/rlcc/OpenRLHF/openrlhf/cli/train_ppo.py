...
def check_environment(rank=0):
    ...
    print(f"\n{'='*80}")
    print(f"[Rank {rank}] Outter 分布式训练环境信息:")
    print(f"{'='*80}")
    print(f"• 进程信息:")
...
def train(args):
    ...
    check_environment(os.environ.get('LOCAL_RANK', 'unknown'))
    ...
    if not args.remote_rm_url:
        reward_model = get_llm_for_sequence_regression(
            args.profile_predicter_model_path,
            "reward",
            normalize_reward=args.normalize_reward,
            use_flash_attention_2=args.flash_attn,
            bf16=args.bf16,
            ...
            profile_predicter_model_path=args.profile_predicter_model_path,
            simcse_model_path=args.simcse_model_path,
            profile_generation_batch_size=args.profile_generation_batch_size,
            ai_detector_model_path=args.ai_detector_model_path,
            ai_detect_batch_size=args.ai_detect_batch_size,
            ai_detect_max_len=args.ai_detect_max_len,
        )
    else:
        reward_model = None
    ...
    if reward_model:
        strategy.print("reward model: {}".format(reward_model))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--api_key", type=str, default="sk-npSRVdUhy5gszhxT508aE80f6f0d40638a6b8309DbF5E569")
    parser.add_argument("--model_name", type=str, default="gpt-4o-mini")
    parser.add_argument("--api_base", type=str, default="https://api.ai-gaochao.cn")
